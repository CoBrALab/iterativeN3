...
if [[ ${_arg_standalone} == "on" ]]; then
  ...
  mincresample -clobber -unsigned -short -tfm_input_sampling -transform ${tmpdir}/transform_to_input.xfm ${tmpdir}/denoise_corrected.mnc $(dirname ${_arg_output})/$(basename ${_arg_output} .mnc).denoise.mnc
